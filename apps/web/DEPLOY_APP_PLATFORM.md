...
Use these settings when creating or editing the **web** app component on App Platform. Do not deploy the backend (api) in this step; this spec is for the frontend only.
