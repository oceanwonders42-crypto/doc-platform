...
/** User-friendly message for common codes */
...
/** Wrapper for fetch that returns { ok, data } or { ok: false, error, code }. Uses safe JSON parsing to avoid HTML-as-JSON errors. */
...
/** Retry a promise with simple backoff. Good for transient failures. */
