...
export default function AdminJobsPage() {
  ...
  return (
    ...
    >
      ...
      {!data?.ok && !loading && <p style={{ color: "#c00" }}>Failed to load jobs.</p>}
          ...
          {jobs.map((job) => (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6, flexWrap: "wrap" }}>
                ...
                <span style={{ fontSize: 12, color: "#888" }}>{formatDate(job.createdAt)}</span>
                {job.attempts > 0 && (
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: 12, fontSize: 14 }}>
              ...
              <strong>Run at:</strong> {formatDate(selectedJob.runAt)}
            </div>
            ...
            {selectedJob.lastError && (
              <div style={{ marginBottom: 12 }}>
                <strong style={{ fontSize: 14, color: "#c00" }}>Last error</strong>
                <pre
                  style={{
                    margin: "4px 0 0 0",
                    fontSize: 12,
