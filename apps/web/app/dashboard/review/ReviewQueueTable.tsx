...
export default function ReviewQueueTable({ documents, cases, initialNextCursor = null, features = { insurance_extraction: false, court_extraction: false } }: Props) {
  ...
  return (
    <>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: canBulkConfirm ? "#efe" : "#eee",
              color: canBulkConfirm ? "#000" : "#999",
            }}
          >
            Bulk Confirm
          </button>
          <button
            ...
            style={{
              ...
              background: bulkAction === null ? "#fee" : "#eee",
            }}
          >
            Bulk Reject
          </button>
          ...
          <button
            ...
            style={{
              ...
              background: canBulkMarkNeedsReview ? "#fff8e6" : "#eee",
              color: canBulkMarkNeedsReview ? "#000" : "#999",
            }}
          >
            Mark Needs Review
          </button>
          <button
            ...
            style={{
              ...
              background: canBulkMarkUnmatched ? "#fee" : "#eee",
              color: canBulkMarkUnmatched ? "#000" : "#999",
            }}
          >
            Mark Unmatched
          </button>
      ...
      {bulkErrors.length > 0 && (
        <div style={{ marginBottom: 12, padding: 10, background: "#fff0f0", border: "1px solid #fcc", borderRadius: 6 }}>
            ...
            <tbody>
              {filtered.map((doc, idx) => {
                ...
                >
                  ...
                  <td style={{ padding: "10px 8px" }}>{doc.clientName ?? "—"}</td>
                  <td style={{ padding: "10px 8px" }}>
                    {doc.suggestedCaseId ? (
                      <Link
                      ...
                      <>
                        <span
                          style={{
                            ...
                            fontSize: 13,
                            fontWeight: 500,
                            background: isRoute ? "#e8f5e9" : "#f5f5f5",
                            border: isRoute ? "1px solid #a5d6a7" : "1px solid #e0e0e0",
                            color: isRoute ? "#1b5e20" : "#424242",
                          }}
                        >
                          Route
                          {isRoute && " ✓"}
                        ...
                        <span
                          style={{
                            ...
                            fontSize: 13,
                            fontWeight: 500,
                            background: isReject ? "#ffebee" : "#f5f5f5",
                            border: isReject ? "1px solid #ef9a9a" : "1px solid #e0e0e0",
                            color: isReject ? "#b71c1c" : "#424242",
                          }}
                        >
                          Reject
                          {isReject && " ✓"}
                        ...
                        <span
                          style={{
                            ...
                            fontSize: 13,
                            fontWeight: 500,
                            background: isReview ? "#fff3e0" : "#f5f5f5",
                            border: isReview ? "1px solid #ffcc80" : "1px solid #e0e0e0",
                            color: isReview ? "#e65100" : "#424242",
                          }}
                        >
                          Review manually
                          {isReview && " ✓"}
      ...
      {toastMessage != null && (
        <div
          ...
          style={{
            ...
            border: toastType === "success" ? "1px solid #a5d6a7" : "1px solid #ef9a9a",
            color: toastType === "success" ? "#1b5e20" : "#b71c1c",
          }}
        >
