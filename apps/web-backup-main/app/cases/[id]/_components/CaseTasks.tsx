          ...
          {items.map((task) => {
            ...
            <li
              ...
              style={{
                ...
                padding: "12px 14px",
                marginBottom: 8,
                border: isOverdue ? `1px solid ${statusColors.error.border}` : "1px solid #e5e5e5",
                borderRadius: 8,
                background: isOverdue ? statusColors.error.bg : "#fafafa",
              }}
            >
              <input
                type="checkbox"
              ...
              <div style={{ flex: 1 }}>
                ...
                {(task.dueDate || task.completedAt) && (
                  <div style={{ marginTop: 4, fontSize: 12, color: isOverdue ? statusColors.error.text : "#888" }}>
                    {task.dueDate && (
                      <>
