...
export default async function UsagePage() {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 900, margin: "0 auto", fontFamily: "system-ui, -apple-system" }}>
      ...
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 20 }}>Usage &amp; metering</h1>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        {usage.updatedAt && (
          <p style={{ fontSize: 12, color: "#888", marginTop: 8 }}>Updated: {formatTimestamp(usage.updatedAt)}</p>
        )}
      </section>
      ...
      {byMonth.length > 0 && (
        <section>
          ...
          <div className="table-scroll-wrapper" style={{ marginTop: 20 }}>
