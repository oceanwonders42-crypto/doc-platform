-- Platform stability: extend SystemErrorLog, add AppBugReport
...
CREATE INDEX "AppBugReport_firmId_idx" ON "AppBugReport"("firmId");
CREATE INDEX "AppBugReport_status_idx" ON "AppBugReport"("status");
CREATE INDEX "AppBugReport_priority_idx" ON "AppBugReport"("priority");
CREATE INDEX "AppBugReport_createdAt_idx" ON "AppBugReport"("createdAt");
