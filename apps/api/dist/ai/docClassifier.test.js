 ...
 */
const docClassifier_1 = require("./docClassifier");
const court_1 = require("./extractors/court");
const insurance_1 = require("./extractors/insurance");
...
const courtOut = (0, docClassifier_1.classify)(COURT_FIXTURE, "notice_of_hearing.pdf");
...
const insOut = (0, docClassifier_1.classify)(INSURANCE_FIXTURE, "claim_letter.pdf");
...
const medOut = (0, docClassifier_1.classify)(MEDICAL_FIXTURE, "records.pdf");
assert(medOut.docType === "medical_record" || medOut.docType === "unknown", `Expected medical_record or unknown, got ${medOut.docType}`);
assert(medOut.docType === "medical_record" ? medOut.confidence >= 0.5 : true, "Expected confidence >= 0.5 when medical_record");
console.log("  ✓ classifier: medical fixture");
// Court extractor
const courtFields = (0, court_1.extractCourt)(COURT_FIXTURE);
...
// Insurance extractor
const insFields = (0, insurance_1.extractInsurance)(INSURANCE_FIXTURE);
