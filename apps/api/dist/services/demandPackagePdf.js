...
exports.buildDemandPackagePdf = buildDemandPackagePdf;
/**
...
async function buildDemandPackagePdf(input) {
    ...
    for (const sec of sections) {
        if (!sec.text || !String(sec.text).trim())
            continue;
